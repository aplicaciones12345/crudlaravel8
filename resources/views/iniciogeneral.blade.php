	...
	<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                <a href="{{ route('login') }}" class="text-sm text-gray-700 nav-link">Acceder</a>
              </li>
              
              <li class="nav-item">
                <a href="{{ route('register-user') }}" class="text-sm text-gray-700 nav-link">Registro</a>
              </li>
            </ul>
        ...
        <div class="contenido-centrado">
            ...
            <div>
                ...
                <img class="img-fluid" src="{{ asset('images/trabajo.webp') }}">
            </div>
        </div>

        <!--footer-->
        <footer class="bg-light">
            <p style="color: black">Created by Xabi@2021</p>
        </footer>
	</div>
